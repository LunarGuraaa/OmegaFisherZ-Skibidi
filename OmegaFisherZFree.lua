...
local Window = Fluent:CreateWindow({
    Title = "OmegaFisherZ Hub Blox-fruits [ Free ]",
    SubTitle = "by Tobi",
    TabWidth = 160,
...
function InfAbility()
    if _G.SpeedHack then
        if not game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
            ...
            inf.Texture = "rbxassetid://75177922589625"
...
local ToggleHumanandghoul = Tabs.Race:AddToggle("ToggleHumanandghoul", {Title = "Auto [ Human / Ghoul ] Trial [ Premium ]", Default = false })
...
local ToggleAutotrial = Tabs.Race:AddToggle("ToggleAutotrial", {Title = "Auto Trial [ Premium ]", Default = false })
...
Tabs.Misc:AddButton({
	...
	Callback = function()
        for i, v in pairs(game:GetObjects("rbxassetid://75177922589625")[1]:GetChildren()) do
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "rbxassetid://75177922589625"
...
spawn(function()
    while wait() do
        ...
        if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=75177922589625" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=75177922589625" then
            wait(2.0)
        elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=75177922589625" then
            Hop()
            Fluent:Notify({
                Title = "OmegaFisherZ Hub",
